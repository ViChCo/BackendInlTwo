    ...
    public static void main(String[] args) {
        ...
        try (ClassPathXmlApplicationContext container =
            ...
            CustomerManagementService customerService =
                    container.getBean("customerService", CustomerManagementService.class);
            ...
            // 2: Registrera samtal via CallHandlingService
            ...
            DiaryManagementService diaryService =
                    container.getBean("diaryService", DiaryManagementService.class);
